...
# Argo 域名
ARGO_DOMAIN="argoman.leaf1314.us.kg"
...
# Argo 配置信息
ARGO_AUTH='eyJhIjoiZDIyYzdiMTJiOGFmMTE2NjhjZTQyYTFlZTA5Yzc1MDYiLCJ0IjoiNGMxYWRhODItNGIzNC00ZTU2LWFkYmYtYzZkYzBkZDU5ZmRlIiwicyI6IlkyWXpNbUl6TURBdE5qQXlaUzAwT1daa0xUbGtZVFl0WmpjeVpUWmxNMll3TlRsaiJ9'
CFPORT=8443
...
install_argo() {
    echo "开始执行远程安装脚本..."
    bash -c "ARGO_AUTH='$ARGO_AUTH' ARGO_DOMAIN='$ARGO_DOMAIN' CFPORT='$CFPORT' CFIP='$CFIP' PORT='$PORT' bash <(curl -Ls https://github.love999.us.kg/onlyno999/xxxxxxxxxx/main/vmess/argo.sh)"
